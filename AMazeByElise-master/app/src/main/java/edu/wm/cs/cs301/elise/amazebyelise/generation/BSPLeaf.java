...
import edu.wm.cs.cs301.elise.amazebyelise.generation.MazeFileWriter;
...
public class BSPLeaf extends BSPNode {
    ...
    private void updateBounds(ArrayList<Seg> sl) {
	    /*
		setLowerBoundX(1000000); // poor programming, supposed to be largest possible integer
		setUpperBoundX(-1000000); // poor programming, supposed to be smallest possible integer
		setLowerBoundY(1000000); // poor programming, supposed to be largest possible integer
		setUpperBoundY(-1000000); // poor programming, supposed to be smallest possible integer
